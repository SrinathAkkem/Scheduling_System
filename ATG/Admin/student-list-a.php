		  ...
		  <div align="center">
		    ...
		    <table width="75%" align="center" border="0" cellpadding="2">
              <tr>
                ...
                <td width="213" nowrap="nowrap" bgcolor="#CCCCCC"><span class="style25">Dept</span></td>
...
// sending query
$result = mysqli_query($conn,"SELECT `course`.*, `dept`.`department` FROM
  			`course`,`dept` WHERE course.dept_id=dept.dept_id ");
if (!$result) 
	{
...
If ($numberOfRows == 0) 
	...
	while ($i<$numberOfRows)
		{		
			...
			$course_dept = MYSQL_RESULT($result,$i,"department");
...
?>
              ...
              <tr bgcolor="<?php echo $bgcolor; ?>">
                ...
                <td nowrap="nowrap"><?php echo $course_dept; ?></td>
