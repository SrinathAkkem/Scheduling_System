...
If ($numberOfRows == 0) 
	...
	while ($i<$numberOfRows)
		{		
			...
			$etime= MYSQL_RESULT($result,$i,"time_e_id");
			


	if ($hidden_pt == $teacher and $hidden_proom == $room and $hidden_pday == $day){
...
mysql_query ("INSERT INTO sched(course_id, sub_id, teacher_id, room_id, sem_id, year_id, day_id, time_s_id, time_e_id)
