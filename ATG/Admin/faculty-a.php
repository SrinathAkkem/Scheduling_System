...
if (($flagfaculty_name == "") && ($flagdept == ""))
{
		...
		$des= $_POST['txtd'];
			...
			VALUES('$faculty_name','$acad_rank','$des', '$dept')") or die(mysqli_error($result)); 
...
<div id="container">
  <div id="header">
	...
	<li class=" cssMenui"><a class="  cssMenui" href="admin.php"><img src="../images/homepage.gif" border="0" />Home</a></li>
