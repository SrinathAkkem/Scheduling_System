...
if (!$result) 
   ...
   if (isset($_POST['cmdSubmit'])) 
  	{ 		
			...
			mysqli_query ($conn,"UPDATE course SET course_yrSec = '$course_yrSec_a', dept_id = '$department_a', major = '$major_a' WHERE course_id = '$Course_ID'")
					 or die(mysqli_error()); 
		...
		<form name="form1" method="post" >
		  <div align="center">
		    ...
		    <table border="0" align="center" >
              <tr >
                <td width="171" height="34" ><div align="right" class="style3">Course Year and Section </div></td>
                <td width="314" ><input type="text" name="txtcourse" id="txtcourse" value="<?php echo $course_yrSec ?>" /></td>
                <td width="96"><span class="style20"><?php echo $flagcourse; ?>&nbsp;</span></td>
              </tr>
              <tr >
