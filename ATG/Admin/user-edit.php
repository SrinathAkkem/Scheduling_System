...
<?php 
   ...
   if (isset($_POST['cmdSubmit'])) 
  	{ 		
		 	...
		 	$username_a= $_POST['txtuser'];
			$userpass_a = $_POST['txtpass'];
			$Dept_a= $_POST['pdept'];
		

			mysqli_query ($conn,"UPDATE user SET username = '$username_a', userpass = '$userpass_a', dept_id = '$Dept_a' WHERE user_id = '$user_id'")
					 or die(mysqli_error()); 
		    ...
		    <form method="post" name="form1" id="form1" >
		      <div align="center">
                ...
                <table border="0" align="center" >
                  <tr >
                    <td width="106" height="34" ><div align="right" class="style3">User Name </div></td>
                    <td width="283"><input type="text" name="txtuser" id="txtuser" value="<?php echo $username; ?>" /></td>
                    <td width="20" ><span class="style20">&nbsp;</span></td>
                    <td width="5" >&nbsp;</td>
                  </tr>
                  <tr >
                    <td height="34"><div align="right" class="style3">Password</div></td>
                    <td ><input type="password" name="txtpass" id="txtpass" value= "<?php echo $userpass; ?>"/></td>
