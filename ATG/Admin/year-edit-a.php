...
-->
   ...
   $year_id =$_REQUEST['year_id'];
	...
	$result = mysql_query("SELECT * FROM school_yr where year_id = '$year_id'");
	if (!$result) 
		{
...
if (isset($_POST['cmdSubmit'])) 
  	{ 	
			...
			mysql_query( "UPDATE school_yr SET school_year = '$year' WHERE year_id = '$year_id'")
		             or die(mysql_error()); 
...
<div id="container">
  <div id="header">
    ...
    <div id="logo_w2"><img src="../images/logo copy.jpg" alt="sched" width="717" height="160" /></div>
	  ...
	  <div id="left">
		<form  name="form1" method="post" >
		  <div align="center">
		    ...
		    <p>Edit School Year </p>
		    <table border="0" align="center">
              <tr >
                <td width="240" height="34" ><div align="right" class="style3">School Year </div></td>
                <td width="349"><input type="text" name="txtyear" id="txtyear" value="<?php echo $SY; ?>" /></td>
                <td width="42" >&nbsp;</td>
                <td width="17">&nbsp;</td>
              </tr>
              <tr >
