	...
	<div id="content">
		...
		<form action="<?php echo $_SERVER[PHP_SELF] ?>" name="form1" method="post" >
		  <div align="center">
		    ...
		    <p><strong>List of School Year</strong></p>
		    <table border="0" align="center" cellpadding="2">
              <tr>
                <td width="199" nowrap="nowrap" bgcolor="#CCCCCC"><span class="style25">School Year</span></td>
...
$result = mysqli_query($conn,"SELECT * FROM school_yr");
if (!$result) 
	{
...
?>
              ...
              <tr bgcolor="<?php echo $bgcolor; ?>">  
                <td nowrap="nowrap"><?php echo $SY; ?></td>
                <td><a href="year-edit-a.php?year_id=<?php echo $year_id; ?>"> <img src='../images/b_edit.png' alt="edit record" width="16" height="16" /></a></td>
                <td><a href="year-del-a.php?year_id=<?php echo $year_id; ?>"> <img src='../images/b_drop.png' alt="delete record" width="16" height="16" onclick="return confirm('<?php echo "Are you sure you want to delete ". $school_year. " school year?"; ?>');" /></a></td>
              </tr>
              <?php 	
		$i++;		
		}
