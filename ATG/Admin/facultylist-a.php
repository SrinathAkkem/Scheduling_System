		      ...
		      <div align="center">
		        ...
		        <table width="526" border="0">
                  <tr>
                    ...
                    <td width="234" nowrap="nowrap" bgcolor="#CCCCCC"><span class="style25">Department</span></td>
...
// sending query
$result = mysqli_query($conn,"SELECT `profile`.*, `dept`.`department` FROM
  			`profile`,`dept` WHERE profile.dept_id=dept.dept_id ");
if (!$result) 
	{
...
?>
	              ...
	              <tr bgcolor="<?php echo $bgcolor; ?>">
	                ...
	                <td nowrap="nowrap"><div align="left"><?php echo $Dept; ?></div></td>
