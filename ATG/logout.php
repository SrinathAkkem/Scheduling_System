...
<body>
<div id="container">
	<div id="header"><img src="../../ATG/images/logo copy.jpg" alt="s" width="717" height="160" />
	  <div id="logo_w2"></div>
		<ul class="cssMenu cssMenum">
	<li class=" cssMenui"><a class="  cssMenui" href="cit_main.php"><img src="../../ATG/images/homepage.gif" width="14" height="15" />Home</a></li>
