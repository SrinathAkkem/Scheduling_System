...
$hidden_pcourse= $_POST['hidden_pcourse'];
			 header(
			 		"Location: search_2.php?pCourse=". $_POST['pcourse'] 
					."&pSy=". $_POST['psy'] 
					."&psem=". $_POST['psem'] 					
		 		   );				   				   
		//	}		 	 
...
<div id="container">
  ...
  <div id="content">
		...
		<form action="<?php echo $_SERVER[PHP_SELF] ?>" name="form1" method="post" >
		  ...
		  <table width="448" border="0" align="left" >
            <tr >
...
<!-- 
		...
		-->
		  ...
		  <p>&nbsp;</p>
		  <p><span class="style30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="style30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	      &nbsp;</span></p>
  ...
  &nbsp;</span></p>
		...
		<p>&nbsp;</p>
		<div id="footerline">
		  <p align="center"><span class="style4"><a href="Admin/help.html">Help</a> |<a href="Admin/developer.html"> Developer</a>| <a href="Admin/scheduling_system.html">ATG</a>| <a href="Admin/contact.html">Contact Us</a>| <a href="Admin/www.chmsc.edu.ph">CHMSC </a></span></p>
		</div>
  </div>
