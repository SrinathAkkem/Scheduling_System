		  ...
		  <div id="div">
		    <form action="<?php echo $_SERVER[PHP_SELF] ?>" method="post" name="form1" id="form1" >
		      <div align="center">
		        ...
		        <p><strong>List of Teachers </strong></p>
		        <p>&nbsp;</p>
		        <p><strong>College of Industrial Technology </strong></p>
		        <p>&nbsp;</p>
		        <table width="524" border="0" align="center">
                  <tr>
                    <td width="476" height="25" nowrap="nowrap" ><span class="style25">Faculty Name </span></td>
...
?>
	              ...
	              <tr bgcolor="<?php echo $bgcolor; ?>">
	                ...
	                <td><a href="faculty-edit-cit.php?profile_no=<?php echo $profile_no; ?>"> <img src='../images/b_edit.png' alt="edit record" width="16" height="16" border="0" /></a></td>
	                <td><a href="faculty-del-cit.php?profile_no=<?php echo $profile_no; ?>"> <img src='../images/b_drop.png' alt="delete record" width="16" height="16" onclick="return confirm('<?php echo "Are you sure you want to delete a faculty named ". $faculty_name. "?"; ?>');" /></a></td>
                  </tr>
                  <?php 	
		$i++;		
		}
...
?>
		        ...
		        <div align="center">
		          <table width="519" border="0" align="center">
		            <tr>
		              <td width="519" ><span class="style25">Faculty Name </span></td>
                      <?php 
...
?>
		        ...
		        <div align="center">
		          <table width="525" border="0">
                    <tr>
                      <td width="513"><span class="style25">Faculty Name </span></td>
                      <?php 
