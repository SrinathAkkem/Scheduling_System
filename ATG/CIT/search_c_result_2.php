 ...
 and sched.year_id=school_yr.year_id  HAVING course_id='$pCourse' and sem_id='$psem' and year_id='$pSy' and dept_id = 2");
		...
		?>
          ...
          <tr bgcolor="<?php echo $bgcolor; ?>">
                ...
                <td width="14"><a href="sched_c_del.php?sched_id=<?php echo $sched_id; ?>&amp;pCourse=<?php echo $pCourse; ?>&amp;pSy=<?php echo $pSy; ?>&amp;psem=<?php echo $psem; ?>"> <img src='../images/b_drop.png' alt="delete record" width="16" height="16" border="0" onclick="return confirm('<?php echo "Are you sure you want to delete file #". $sched_id. "?"; ?>');" /></a></td>
              </tr>
              <?php 
			  $i++;		
			}
	...
	?>
          ...
          <table width="708" border="1" align="center">
              <tr>
                ...
                <td width="113"><div align="center">WEDNESDAY</div></td>
                <td width="115"><div align="center">THURSDAY</div></td>
                <td width="105"><div align="center">FRIDAY</div></td>
              </tr>
              <tr>
