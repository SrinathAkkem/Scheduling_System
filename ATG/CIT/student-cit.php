	...
	<div id="content">
	  ...
	  <div id="left">
		<form action="<?php echo $_SERVER[PHP_SELF] ?>" name="form1" method="post" >
		  <div align="center">
		    <p><strong>College of Industrial Technology 
		    </strong></p>
		    <p align="center"><strong>Add Course</strong></p>
		    <table border="0" align="center" >
              <tr >
                <td width="162" height="34" ><div align="right" class="style3">Course Year and Section </div></td>
                <td width="230" ><input type="text" name="txtcourse" id="txtcourse" value="<?php echo $faculty_name; ?>" /></td>
                <td width="93"><span class="style20"><?php echo $flagcourse; ?>&nbsp;</span></td>
              </tr>
              <tr >
                <td height="37" ><div align="right" class="style3">Major</div></td>
