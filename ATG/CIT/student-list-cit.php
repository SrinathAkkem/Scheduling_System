	...
	<div id="content">
	  ...
	  <div id="left">
		  <form action="<?php echo $_SERVER[PHP_SELF] ?>" name="form1" method="post" >
            <div align="center">
              <p><strong>College of Industrial Technology <br />
                            </strong></p>
...
?>
                ...
                <tr bgcolor="<?php echo $bgcolor; ?>">
                  ...
                  <td><a href="student-edit-cit.php?Course_ID=<?php echo $Course_ID; ?>"> <img src='../images/b_edit.png' alt="edit record" width="16" height="16" /></a></td>
                  <td><a href="student-del-cit.php?Course_ID=<?php echo $Course_ID; ?>"> <img src='../images/b_drop.png' alt="delete record" width="16" height="16" onclick="return confirm('<?php echo "Are you sure you want to delete ". $course_yrSec. "?"; ?>');" /></a></td>
                </tr>
                <?php 	
		$i++;		
		}
