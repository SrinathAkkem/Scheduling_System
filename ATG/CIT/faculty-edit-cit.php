		  ...
		  <div id="div">
		    <form method="post" name="form1" id="form1" >
		      <div align="center">
		        ...
		        <p><strong>Edit Faculty <br /></strong></p>

		        <table border="0" align="center" >
                  <tr >
                    <td width="113" height="34" ><div align="right" class="style3">Faculty Name </div></td>
                    <td width="253"><input type="text" name="txtuser" id="txtuser" value="<?php echo $faculty_name; ?>" /></td>
                    <td width="78" ><span class="style20">&nbsp;</span></td>
                    <td width="4" >&nbsp;</td>
                  </tr>
                  <tr >
