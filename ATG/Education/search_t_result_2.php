...
if (!$result) 
		...
		die("Query to show fields from table failed");
            ...
            <table width="673" border="0" align="center">
              <tr>
                <td width="109" height="54"><span class="style32">Teacher:</span></td>
...
if (!$result1) 
 ...
 and sched.year_id=school_yr.year_id HAVING teacher_id='$pT' and sem_id='$psem' and year_id='$pSy'
	...
	?></td>
              ...
              <tr>
                <td>Course</span></td>
                <td width="66" >Subject</span></td>
                <td width="66" >Room</span></td>
                <td width="64">Day </span></td>
                <td width="137" >Starting time</span></td>
                <td width="179" >SY</span></td>
                <td width="22" >&nbsp;</td>
                <?php
 ...
 and sched.year_id=school_yr.year_id HAVING teacher_id='$pT' and sem_id='$psem' and year_id='$pSy' and dept_id = 3");
	...
	?>
		  ...
		  <table width="695" border="1" align="center">
		    <tr>
		      <td width="98"><div align="center" class="style33">TIME</div></td>
		      <td width="111"><div align="center" class="style33">MONDAY</div></td>
		      <td width="114"><div align="center" class="style33">TUESDAY</div></td>
		      <td width="119"><div align="center" class="style33">WEDNESDAY</div></td>
		      <td width="108"><div align="center" class="style33">THURSDAY</div></td>
		      <td width="105"><div align="center" class="style33">FRIDAY</div></td>
	        </tr>
		    <tr>
