		  ...
		  <div align="center">
		    ...
		    <table align="center" border="0">
              <tr>
                ...
                <td width="168" nowrap="nowrap" bgcolor="#CCCCCC"><span class="style25">Course </span></td>
                <td width="293" nowrap="nowrap" bgcolor="#CCCCCC"><span class="style25">Major </span></td>
                <td width="14" nowrap="nowrap" bgcolor="#CCCCCC">&nbsp;</td>
                <td width="14" nowrap="nowrap" bgcolor="#CCCCCC">&nbsp;</td>
                <?php 

// sending query
$result = mysql_query("SELECT * from course WHERE course.dept_id='1' ");
if (!$result) 
	{
...
?>
              ...
              <tr bgcolor="<?php echo $bgcolor; ?>">
                ...
                <td><a href="student-edit-educ.php?Course_ID=<?php echo $Course_ID; ?>"> <img src='../images/b_edit.png' alt="edit record" width="16" height="16" /></a></td>
                <td><a href="student-del-educ.php?Course_ID=<?php echo $Course_ID; ?>"> <img src='../images/b_drop.png' alt="delete record" width="16" height="16" onclick="return confirm('<?php echo "Are you sure you want to delete ". $course_yrSec. "?"; ?>');" /></a></td>
              </tr>
              <?php 	
		$i++;		
		}
...
?>
		    ...
		    <table width="523" border="0" align="center" cellpadding="2">
              <tr>
                <td width="165"><span class="style25">Course </span></td>
                <td width="306"><span class="style25">Major </span></td>
                <?php 
...
?>
		    ...
		    <p>&nbsp;</p>
		    <p><strong>College of Arts and Sciences  Teachers</strong> </p>
		    <table width="523" border="0" align="center" cellpadding="2">
              <tr>
                <td width="165"><span class="style25">Course </span></td>
                <td width="306"><span class="style25">Major </span></td>
