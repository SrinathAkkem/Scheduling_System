		...
		<form name="form1" method="post" >
		  <div align="center">
		    ...
		    <table border="0" align="center" >
              <tr >
                <td width="172" height="34" ><div align="right" class="style3">Course Year and Section </div></td>
                <td width="187" ><input type="text" name="txtcourse" id="txtcourse" value="<?php echo $course_yrSec ?>" /></td>
                <td width="147"><span class="style20"><?php echo $flagcourse; ?>&nbsp;</span></td>
              </tr>
              <tr >
