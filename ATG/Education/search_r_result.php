...
if (!$result) 
		...
		die("Query to show fields from table failed");
		    ...
		    <table width="669" border="0" align="center">
              <tr>
                <td width="68" height="43"><span class="style32">Room:</span></td>
		...
		die("Query to show fields from table failed");
			...
			$room = MYSQL_RESULT($result,$i,"room_name");
              ...
              <tr>
                ...
                <td width="105" >Teacher</span></td>
                <td width="112">Day </span></td>
                <td width="97" >Starting time</span></td>
                <td width="132" >SY</span></td>
                <td width="19" >&nbsp;</td>
                <?php
			$pRoom =$_REQUEST['pRoom'];
			$pSy =$_REQUEST['pSy'];
