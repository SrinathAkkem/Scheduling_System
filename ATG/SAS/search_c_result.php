...
if (!$result) 
		...
		die("Query to show fields from table failed");
		    ...
		    <table width="541" border="0" align="center">
              <tr>
                <td height="50"  colspan="6"><span class="style32">Course: <?php echo $course; ?></span></td>
                <td width="11">&nbsp;</td>
              </tr>
              <tr>
                <td width="88">Subject</span></td>
                <td width="93" >Teacher</span></td>
                <td width="60" >Room</span></td>
                <td width="55">Day </span></td>
                <td width="149" >Starting time</span></td>
                <td width="55" >SY</span></td>
                <td >&nbsp;</td>
                <?php
...
<p><br />
		    ...
		    <table width="704" border="1" align="center">
		      <tr>
		        <td width="99"><div align="center" class="style1">TIME</div></td>
		        <td width="117"><div align="center" class="style1">MONDAY</div></td>
		        <td width="118"><div align="center" class="style1">TUESDAY</div></td>
		        <td width="114"><div align="center" class="style1">WEDNESDAY</div></td>
		        <td width="113"><div align="center" class="style1">THURSDAY</div></td>
		        <td width="103"><div align="center" class="style1">FRIDAY</div></td>
	          </tr>
		      <tr>
