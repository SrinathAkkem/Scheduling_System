...
if ($conflict != true){
			...
			mysql_query ("INSERT INTO sched(course_id, sub_id, teacher_id, room_id, sem_id, year_id, day_id, time_s_id, dept_id)
					VALUES('$hidden_pcourse', '$hidden_psubcat','$hidden_pt','$hidden_proom','$hidden_psem','$hidden_psy','$hidden_pday','$hidden_pstime', 3)") or die(mysql_error()); 
		  ...
		  <div align="center"><br />
		    ...
		    <div id="layer">
              <div align="justify" class="style31">
                <div align="center"><span class="style5">College of Arts and Sciences </span><br>
                  <br>
                </div>
		    ...
		    <table border="0" align="center">
              ...
              <tr >
				...
				$result = mysql_query("SELECT  * FROM `course` ORDER BY `course`.`course_yrSec`;");			  	
				do {  ?>
              ...
              <tr >
                ...
                <td ><span class="style22">
                  ...
                  <select name="psub"  id="psub" style="width: 267px" onchange="javascript: return optionList2_SelectedIndex()">
                    <?php // source 1: http://www.dmxzone.com/showDetail.asp?NewsId=5102&TypeId=25
			  	// source 2: http://localhost/phpmyadmin/index.php?db=mydbase&token=651c0063e511c381c9c82ce1fe9b6854
				$result = mysql_query("SELECT  * FROM `subjects` WHERE `subjects`.`dept_id` = 3 ORDER BY `subjects`.`sub_code`;");			  	
				do {  ?>
              ...
              <tr >
                ...
                <td ><span class="style22">
                  ...
                  <select name="pteacher"  id="pteacher" style="width: 267px" onchange="javascript: return optionList3_SelectedIndex()">
                    <?php // source 1: http://www.dmxzone.com/showDetail.asp?NewsId=5102&TypeId=25
			  	// source 2: http://localhost/phpmyadmin/index.php?db=mydbase&token=651c0063e511c381c9c82ce1fe9b6854
				$result = mysql_query("SELECT  * FROM `profile` WHERE `profile`.`dept_id` = 3 ORDER BY `profile`.`teacher_name`");			
				do {  ?>
