		...
		<form action="<?php echo $_SERVER[PHP_SELF] ?>" name="form1" method="post" >
		  <div align="center">
		    ...
		    <table border="0" align="center" >
              <tr >
                <td width="91" height="34" ><div align="right" class="style3">Faculty Name </div></td>
                <td width="293" ><input type="text" name="txtfaculty_name" id="txtfaculty_name" value="<?php echo $faculty_name; ?>" /></td>
                <td width="18"><span class="style20"><?php echo $flagfaculty_name; ?>&nbsp;</span></td>
                <td width="0">&nbsp;</td>
              </tr>
              <tr >
