...
<div id="container">
	...
	<li class=" cssMenui"><a class="  cssMenui" href="add_entry-sas.php"><span>Add entry</span><![if gt IE 6]></a><![endif]><!--[if lte IE 6]><table><tr><td><![endif]-->
	<ul class=" cssMenum">
	...
	<!--[if lte IE 6]></td></tr></table></a><![endif]--></li>
	<li class=" cssMenui"><a class="  cssMenui" href="#">Schedule</a></li>
	...
	<div id="content">
	  ...
	  <div id="left">
		...
		<div id="right">
		  ...
		  <div id="footerline">
		    <p align="center"><span class="style4"><a href="help.php">Help</a>| <a href="about_sched.php">ATG</a></span></p>
      </div>
</div>
	
	<div id="footer">
	  <div align="center">Four Black Riders</div>
	</div>	
</div>
</body>
</html>
