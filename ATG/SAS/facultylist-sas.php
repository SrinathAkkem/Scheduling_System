	...
	<div id="left">
		  <div id="div">
		    <form action="<?php echo $_SERVER[PHP_SELF] ?>" method="post" name="form1" id="form1" >
		      <div align="left">
		        <p align="center"><strong>College of Arts and Sciences </strong><strong></strong></p>
		        <p align="center"><strong>List of Teachers </strong></p>
		        ...
		        <div align="center">
		          <table align="center" border="0">
		            <tr>
		              <td width="480" height="35" nowrap="nowrap" ><span class="style25">Faculty Name </span></td>
...
?>
		            ...
		            <tr bgcolor="<?php echo $bgcolor; ?>">
                      ...
                      <td><a href="faculty-edit-sas.php?profile_no=<?php echo $profile_no; ?>"> <img src='../images/b_edit.png' alt="edit record" width="16" height="16" border="0" /></a></td>
                      <td><a href="faculty-del-sas.php?profile_no=<?php echo $profile_no; ?>"> <img src='../images/b_drop.png' alt="delete record" width="16" height="16" onclick="return confirm('<?php echo "Are you sure you want to delete a faculty named ". $faculty_name. "?"; ?>');" /></a></td>
                    </tr>
		            <?php 	
		$i++;		
		}
...
?>
			    ...
			    <div align="center">
		          <table width="529" border="0">
		            <tr>
		              <td width="523" height="27" nowrap="nowrap" ><span class="style25">Faculty Name </span></td>
...
?>
		        ...
		        <p align="center">&nbsp;</p>
                <p align="center"><strong>College of Industrial Technology  </strong>                </p>
                <p align="center"><br />
                </p>
                <div align="center">
                  <table align="center" border="0">
                    <tr>
                      <td width="517" height="33" nowrap="nowrap" ><span class="style25">Faculty Name </span></td>
