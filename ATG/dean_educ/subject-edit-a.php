	...
	require ("../includes/dbconnection.php");
		...
		if (!$result) 
			...
			{ 		
					...
					mysql_query ("UPDATE subjects SET sub_code ='$txtccode_a' , sub_name = '$txtcdesc_a', sub_lechrsprday = '$txtlechours_a', sub_labhrsprday = '$txtlabhours_a' , subcat_id = '$hidden_psubcat_a', cys = '$hidden_pcourseid_a', prereq = '$txtprereq_a', sem_id = '$hidden_psem_a' , dept_id = 1  
					 WHERE sub_id  = '$sub_id'")
							 or die(mysql_error()); 
						 header(
