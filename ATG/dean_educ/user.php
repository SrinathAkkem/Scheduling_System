...
if (($flaguser == "") && ($flagpass == ""))
{
			...
			mysql_query ("INSERT INTO user(username, userpass, dept_id)
					VALUES('$user', '$pass',1)") or die(mysql_error()); 
...
<div id="container">
  ...
  <div id="content">
	...
	<div id="right"></div>
		<div id="footerline">
	    <div align="center"><span class="style4"><a href="help.php">Help</a> | <a href="about_dev.php">Developer</a>| <a href="about_sched.php">ATG</a>| <a href="contact.html">Contact Us</a>| <a href="www.chmsc.edu.ph">CHMSC </a></span></div>
	    <p>&nbsp;</p>
    </div>
  </div>
