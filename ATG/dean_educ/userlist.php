		  ...
		  <div id="div">
		    <form action="<?php echo $_SERVER[PHP_SELF] ?>" method="post" name="form1" id="form1" >
		      <div align="center">
		        ...
		        <table width="31%" align="center" border="0" cellpadding="2">
                  <tr>
                    <td width="163" height="21" nowrap="nowrap" bgcolor="#CCCCCC"><span class="style25">User </span></td>
                    <td width="21" nowrap="nowrap" bgcolor="#CCCCCC">&nbsp;</td>
                    <td width="21" nowrap="nowrap" bgcolor="#CCCCCC">&nbsp;</td>
                   <?php 

// sending query
$result = mysql_query("SELECT `user`.* FROM
  			`user` WHERE user.dept_id=1");
if (!$result) 
	{
