...
if ($conflict != true){
			...
			mysql_query ("INSERT INTO sched(course_id, sub_id, teacher_id, room_id, sem_id, year_id, day_id, time_s_id)
					VALUES('$hidden_pcourse', '$hidden_psubcat','$hidden_pt','$hidden_proom','$hidden_psem','$hidden_psy','$hidden_pday','$hidden_pstime')") or die(mysql_error()); 
	...
	<div id="content">
	  <div id="left">
		...
		<div id="right">
		  ...
		  <div id="footerline">
		    <p align="center"><span class="style4"><a href="help.html">Help</a>| <a href="scheduling_system.html">ATG</a></span></p>
	      </div>
</div>
