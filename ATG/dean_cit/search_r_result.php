...
<div id="container">
  ...
  <div id="content">
		...
		<form name="form1" method="post" >
		  <div align="center"><br />
		    <p align="center"><span class="style32">Room Utilization </span> </p>
            <p align="center">
...
if (!$result) 
		...
		die("Query to show fields from table failed");
            ...
            <table width="572" border="0" align="center">
              <tr>
                <td width="56" height="43"><span class="style32">Room:</span></td>
                <td colspan="6"><span class="style32">
                  <?php
					$pRoom =$_REQUEST['pRoom'];
...
if (!$result) 
		...
		die("Query to show fields from table failed");
			...
			$room = MYSQL_RESULT($result,$i,"room_name");
              ...
              <tr>
                <td>Room</td>
                <td width="95" >Subject</td>
                <td width="99" >Teacher</span></td>
                <td width="91">Day </span></td>
                <td width="111" >Starting time</span></td>
                <td width="68" >SY</span></td>
                <?php
			$pRoom =$_REQUEST['pRoom'];
			$pSy =$_REQUEST['pSy'];
			$psem=$_REQUEST['psem'];
